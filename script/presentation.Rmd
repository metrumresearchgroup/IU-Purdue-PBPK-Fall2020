...
author: "Ahmed Elmokadem ahmede@metrumrg.com"
date: ''
output:
  html_document:
    toc: yes
...
<font face = "Brush Script MT" size =" 7">Once upon a time, there was a young, naive and yet brilliant, scientist, who had a thought..
...
## 1. Playing with R and tidyverse

Open a new Rscript file and play a little with R and the package tidyverse..

---

## 2. PBPK Modeling and Simulation
...
- Use package `numDeriv` to generate the 95% CI around the parameter estimates <br>
...
1. Simulate a simple voriconazole dosing scenario for a population of 100 individuals, 50 males and 50 females, with ages ranging between 20-80, weights ranging between 50-100 kg and heights between 1.5 and 1.9 m. Use population saved in file `../data/derived/popPars_100.rds`
...
3. Compare doses 3 and 4 mg/kg for adults. Which dose keeps voriconazole concentration at steady state above MIC (1 mg/L) for >= 90% of subjects?
...
## 6. Shiny - Interactive Document

Explore the simple shiny app saved as `app.R`

---

<font face = "Brush Script MT" size =" 7">..and this is why modeling PBPK in R beats anything else..</font>

![](https://media.giphy.com/media/wrKbZmYC2IQ92/giphy.gif)
